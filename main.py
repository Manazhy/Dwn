...
class Dawn:
    ...
    def log(self, message):
        print(
            f"{Fore.CYAN + Style.BRIGHT}[ {datetime.now().astimezone(wib).strftime('%x %X %Z')} ]{Style.RESET_ALL} CRYPTOCRACKERS "
...
{"*":<1}{" " * 38}{"*":>1}
{"*":<1}{" " * 9}{Fore.YELLOW + Style.BRIGHT} CRYPTOCRACKERS {" " * 10}{Fore.GREEN + Style.BRIGHT}{"*":>1}
{"*":<1}{" " * 38}{"*":>1}
{"*":<1}{Fore.CYAN + Style.BRIGHT}        https://t.me/CRYPTOCRACKERS {" " * 7}{Fore.GREEN + Style.BRIGHT}{"*":>1}
{"*":<1}{" " * 38}{"*":>1}
{"*" * 40}{Style.RESET_ALL}
            """
        )
    ...
    async def question(self):
        while True:
            try:
                print(f"{Fore.YELLOW+Style.BRIGHT}SELECT ANY ONE TO CONTINUE - No Selling")
                print("1. Run With Auto Proxy - ❌ BAN")
                print("2. Run With Manual Proxy- ↗️ Moderate")
                print("3. Run With Proxy - ✅ SAFE")
